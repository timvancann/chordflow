...
impl ScaleType {
    ...
    pub fn display_name(self) -> &'static str {
        ...
        match self {
            ...
            SuperlocrianDoubleFlat7 => "superlocrian ♭♭7",
...
mod tests {
    ...
    fn poster() -> Vec<(ScaleType, ScaleFamily, &'static str, &'static str)> {
        vec![
            ...
            (ScaleType::Dorian, ScaleFamily::Major, "dorian", "R 2 ♭3 4 5 6 ♭7"),
            (ScaleType::Phrygian, ScaleFamily::Major, "phrygian", "R ♭2 ♭3 4 5 ♭6 ♭7"),
            (ScaleType::Lydian, ScaleFamily::Major, "lydian", "R 2 3 ♯4 5 6 7"),
            (ScaleType::Mixolydian, ScaleFamily::Major, "mixolydian", "R 2 3 4 5 6 ♭7"),
            (ScaleType::Aeolian, ScaleFamily::Major, "aeolian", "R 2 ♭3 4 5 ♭6 ♭7"),
            (ScaleType::Locrian, ScaleFamily::Major, "locrian", "R ♭2 ♭3 4 ♭5 ♭6 ♭7"),

            (ScaleType::MelodicMinor, ScaleFamily::MelodicMinor, "melodic minor", "R 2 ♭3 4 5 6 7"),
            (ScaleType::DorianFlat2, ScaleFamily::MelodicMinor, "dorian ♭2", "R ♭2 ♭3 4 5 6 ♭7"),
            (ScaleType::LydianAugmented, ScaleFamily::MelodicMinor, "lydian augmented", "R 2 3 ♯4 ♯5 6 7"),
            (ScaleType::LydianDominant, ScaleFamily::MelodicMinor, "lydian dominant", "R 2 3 ♯4 5 6 ♭7"),
            (ScaleType::MixolydianFlat6, ScaleFamily::MelodicMinor, "mixolydian ♭6", "R 2 3 4 5 ♭6 ♭7"),
            (ScaleType::AeolianFlat5, ScaleFamily::MelodicMinor, "aeolian ♭5", "R 2 ♭3 4 ♭5 ♭6 ♭7"),
            (ScaleType::Altered, ScaleFamily::MelodicMinor, "altered", "R ♭2 ♯2 3 ♭5 ♯5 ♭7"),

            (ScaleType::HarmonicMinor, ScaleFamily::HarmonicMinor, "harmonic minor", "R 2 ♭3 4 5 ♭6 7"),
            (ScaleType::LocrianNatural6, ScaleFamily::HarmonicMinor, "locrian ♮6", "R ♭2 ♭3 4 ♭5 6 ♭7"),
            (ScaleType::IonianAugmented, ScaleFamily::HarmonicMinor, "ionian augmented", "R 2 3 4 ♯5 6 7"),
            (ScaleType::LocrianSharp4, ScaleFamily::HarmonicMinor, "locrian ♯4", "R 2 ♭3 ♯4 5 6 ♭7"),
            (ScaleType::PhrygianDominant, ScaleFamily::HarmonicMinor, "phrygian dominant", "R ♭2 3 4 5 ♭6 ♭7"),
            (ScaleType::LydianSharp9, ScaleFamily::HarmonicMinor, "lydian ♯9", "R ♯2 3 ♯4 5 6 7"),
            (ScaleType::SuperlocrianDoubleFlat7, ScaleFamily::HarmonicMinor, "superlocrian ♭♭7", "R ♭2 ♭3 ♭4 ♭5 ♭6 ♭♭7"),

            // major blues: the poster prints "R 2 ♭3 ♭3 5 6"; confirmed typo,
            // the flat third is followed by the natural third.
            (ScaleType::MajorBlues, ScaleFamily::Other, "major blues", "R 2 ♭3 3 5 6"),
            (ScaleType::MinorBlues, ScaleFamily::Other, "minor blues", "R ♭3 4 ♭5 5 ♭7"),
            (ScaleType::WholeTone, ScaleFamily::Other, "whole tone", "R 2 3 ♯4 ♯5 ♭7"),
            (ScaleType::Augmented, ScaleFamily::Other, "augmented", "R ♯2 3 5 ♯5 7"),
            (ScaleType::DiminishedHalfWhole, ScaleFamily::Other, "diminished half whole", "R ♭2 ♯2 3 ♭5 5 6 ♭7"),
            (ScaleType::DiminishedWholeHalf, ScaleFamily::Other, "diminished whole half", "R 2 ♭3 4 ♭5 ♯5 6 7"),
        ]
    }
